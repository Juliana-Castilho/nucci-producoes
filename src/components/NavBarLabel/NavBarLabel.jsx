        ...
        <div className="justify-between px-4 lg:max-w-7x1 md:absolute md:right-0 md:items-center md:flex md:px-8">
          <div>
            ...
            <div>
              ...
              >
                <ul className="h-screen md:h-max items-center justify-center md:flex">
                  <li className="pb-6 text-orange-200 py-2 md:px-6 text-center border-b-2 md:border-b-0 hover:bg-primary border-primary md:hover:text-primary md:hover:bg-transparent">
